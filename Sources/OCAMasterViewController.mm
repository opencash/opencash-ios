...
#import "OCAMasterViewController.h"
...
@implementation OCAMasterViewController
...
- (void)viewDidLoad
{
  ...
  self.detailViewController = (OCADetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
